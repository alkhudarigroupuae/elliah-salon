...
type Storage interface {
	...
	UpdateBranding(logoURL, faviconURL string) error
...
const defaultLogoURL = "https://elliahsalon.com/wp-content/uploads/2025/08/logo-elliah-salon-jvc-.svg"
...
// variables
// Default categories for Elliah Gents Salon (income = positive, expenses = negative)
var defaultCategories = []string{
	"Services",           // Revenue: haircuts, beard trim, etc.
	"Income",             // Other income
	"Rent",
	"Utilities",
	"Products & Supplies", // Shampoos, gels, etc.
	"Staff & Wages",
	"Equipment",
	"Marketing",
